...
const Flowers = () => {
    return (
        <div>
            ...
            <div>
                <h4 className="font-mono leading-7 mb-6 font-medium">🌸 Siz Quvada guldastaga ishonch bilan buyurtma berishingiz mumkin, chunki biz sotib olingan gullardan imkon qadar uzoq vaqt zavq olishingiz uchun gul tuzilmalarimizning yuqori sifati, yangiligi va mustahkamligiga kafolat beramiz.</h4>
            ...
            <div className="container flex flex-row gap-6 flex-wrap">
                ...
                <div className="flex-1 text-justify min-w-[300px]">
                    <h3 className="font-mono leading-7 text-xl mb-2 sm:mb-8   font-bold ">
