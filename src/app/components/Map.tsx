...
export default function Map() {
    return (
        <div className="w-full bg-gray-100 flex flex-col md:flex-row items-center justify-center py-6 px-4 mt-20">

            <div className="w-full md:w-1/2 h-[300px] md:h-[500px] relative" data-aos="fade-right"
                data-aos-offset="300"
                data-aos-easing="ease-in-sine">

                <iframe allowFullScreen src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d6066.0907624694055!2d72.01807111501688!3d40.51848801224343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sQo&#39;shkechik%20qishlog&#39;i%20murotkosa!5e0!3m2!1sru!2s!4v1757330478116!5m2!1sru!2s" className="w-full h-full rounded-lg shadow-md border-0" loading="lazy" ></iframe>
            </div>
